...
SECRET_KEY = 'django-insecure-imaqb+w1fc8d-vu&thpzt-j=o8o^yzgfh&+++(^e5=y__tg0iy'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / "assets/static/assets",  # Adjust this if your static files are located elsewhere
]
